...
import com.example.fitsync.data.gerakanlatihan.dadaMenengah
...
class LatihanOtotDadaMenengahActivity : AppCompatActivity() {

   private var _binding: ActivityLatihanOtotDadaMenengahBinding? = null
   private val binding get() = _binding!!
   override fun onCreate(savedInstanceState: Bundle?) {
      super.onCreate(savedInstanceState)
      AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_NO)
      _binding = ActivityLatihanOtotDadaMenengahBinding.inflate(layoutInflater)
      ...
      binding.btnStart.setOnClickListener {
         ...
         val intent = Intent(
            this@LatihanOtotDadaMenengahActivity,
            PersiapanLatihanActivity::class.java
         )
         intent.putExtra("gerakan", dadaMenengah)
