...
import com.example.fitsync.databinding.ActivityLatihanOtotLenganPemulaBinding
import com.example.fitsync.ui.persiapanlatihan.PersiapanLatihanActivity

class LatihanOtotLenganPemulaActivity : AppCompatActivity() {
   private var _binding: ActivityLatihanOtotLenganPemulaBinding? = null
   private val binding get() = _binding!!

   override fun onCreate(savedInstanceState: Bundle?) {
      super.onCreate(savedInstanceState)
      AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_NO)
      _binding = ActivityLatihanOtotLenganPemulaBinding.inflate(layoutInflater)
      ...
      binding.btnStart.setOnClickListener {
         ...
         val intent = Intent(
            this@LatihanOtotLenganPemulaActivity,
            PersiapanLatihanActivity::class.java
         )
         intent.putExtra("gerakan", lenganPemula)
