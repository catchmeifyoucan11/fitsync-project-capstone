...
import com.example.fitsync.data.gerakanlatihan.lenganPemula
...
import com.example.fitsync.databinding.ActivityLatihanOtotLenganMenengahBinding
import com.example.fitsync.ui.persiapanlatihan.PersiapanLatihanActivity

class LatihanOtotLenganMenengahActivity : AppCompatActivity() {
   private var _binding: ActivityLatihanOtotLenganMenengahBinding? = null
   private val binding get() = _binding!!
   override fun onCreate(savedInstanceState: Bundle?) {
      super.onCreate(savedInstanceState)
      AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_NO)
      _binding = ActivityLatihanOtotLenganMenengahBinding.inflate(layoutInflater)
      ...
      binding.btnStart.setOnClickListener {
         ...
         val intent = Intent(
            this@LatihanOtotLenganMenengahActivity,
            PersiapanLatihanActivity::class.java
         )
         intent.putExtra("gerakan", lenganMenengah)
